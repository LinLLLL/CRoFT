...
class CustomCLIP(nn.Module):
    ...
    def __init__(self, cfg, classnames, clip_model):
        ...
        self.adapter = Adapter(n_feat, 4).to(clip_model.dtype)
    ...
    def forward(self, image):
        ...
        # energy = torch.exp(image_features @ text_features.t()).sum(dim=-1)
