...
class DataManager:
    ...
    def __init__(
        ...
        # Build ood_test_loader
        # print('ood_test', dataset.ood_test)
        # print('train_x', dataset.train_x)
        ood_test_loader = None 
        if dataset.ood_test:
            ood_test_loader = build_data_loader(
                cfg,
                sampler_type=cfg.DATALOADER.TEST.SAMPLER,
                data_source=dataset.ood_test,
    ...
    def show_dataset_summary(self, cfg):
        ...
        if self.dataset.ood_test:
            print("  # ood_test: {:,}".format(len(self.dataset.ood_test)))
