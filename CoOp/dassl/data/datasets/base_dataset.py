...
class DatasetBase:
    ...
    def __init__(self, train_x=None, train_u=None, val=None, test=None, ood_test=None, alldomain=None):
        ...
        self._classnames_o = self.get_lab2cname(train_x)[1]
        self._classnames_t = self.get_lab2cname(test)[1]
