...
class PACS_Caltech101(DatasetBase):
    dataset_dir = "PACS"
    ...
    def __init__(self, cfg):
        ...
        val = self.generate_fewshot_dataset_balance(val, num_shots=num_shots) if num_shots > 4 \
            else self.generate_fewshot_dataset(val, num_shots=num_shots)

        all_domain = ['art_painting', 'cartoon', 'photo', 'sketch']
        self.base_class = ['dog', 'elephant', 'giraffe', 'guitar', 'horse', 'house', 'person']
        self.new_class = ['pizza', 'flamingo_head', 'trilobite', 'chair', 'lamp', 'stegosaurus', 'barrel',
                          'gerenuk', 'ferry', 'schooner', 'emu', 'brain', 'Motorbikes', 'helicopter', 'flamingo',
                          'wheelchair', 'sunflower', 'scissors', 'crayfish', 'crocodile', 'hedgehog', 'dollar_bill',
                          'cannon', 'stapler', 'pagoda', 'menorah', 'chandelier', 'cup', 'lotus', 'nautilus', 'grand_piano',
                          'sea_horse', 'butterfly', 'accordion', 'gramophone', 'soccer_ball', 'camera', 'laptop', 'watch',
                          'lobster', 'water_lilly', 'dolphin', 'bonsai',
                          'scorpion', 'hawksbill', 'cougar_body', 'BACKGROUND_Google', 'rooster', 'cellphone',
                          ...
                          'windsor_chair', 'platypus', 'pigeon', 'tick', 'binocular', 'crocodile_head', 'ant', 'beaver',
                          'brontosaurus', 'anchor', 'car_side', 'bass', 'ibis', 'ewer', 'umbrella', 'stop_sign', 'airplanes',
                          'mandolin', 'okapi', 'panda', 'ceiling_fan', 'rhino', 'Leopards', 'headphone', 'crab', 'wild_cat']
