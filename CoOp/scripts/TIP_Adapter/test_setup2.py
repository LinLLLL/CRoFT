...
os.system('CUDA_VISIBLE_DEVICES=2 bash test_openood_setup2_vlcs.sh VLCS_DTD ViT_ep30 VLCS')
os.system('CUDA_VISIBLE_DEVICES=2 bash test_openood_setup2_vlcs.sh VLCS_DTD rn50_ep30 VLCS')
os.system('CUDA_VISIBLE_DEVICES=2 bash test_openood_setup2_vlcs.sh VLCS_food101 ViT_ep30 VLCS')
os.system('CUDA_VISIBLE_DEVICES=2 bash test_openood_setup2_vlcs.sh VLCS_food101 rn50_ep30 VLCS')
os.system('CUDA_VISIBLE_DEVICES=2 bash test_openood_setup2_vlcs.sh VLCS_Caltech101 ViT_ep30 VLCS')
os.system('CUDA_VISIBLE_DEVICES=2 bash test_openood_setup2_vlcs.sh VLCS_Caltech101 rn50_ep30 VLCS')
